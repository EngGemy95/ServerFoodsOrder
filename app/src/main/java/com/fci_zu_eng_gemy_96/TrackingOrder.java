...
import com.fci_zu_eng_gemy_96.Common.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback
    ...
    private void displayLocation() {
     ...
     public void drawRoute(final LatLng yourLocation, final String address) {
         Log.d("eeeeeee1", address +" 22");
        mService.getGeoCode(address).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    Log.d("eeeeeee", address +" 22");

                    LatLng orderLocation = new LatLng(30.585810,31.503500);
                    bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.house_order);
